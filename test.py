...
if __name__ == '__main__':
    ...
    # xml_file = r'D:\work\chj-operator\rsi\config\XQRadiometricCorrectionSetting.xml'
    ...
    #     if ele.tag == sensor:
    #         # print(ele.find('SRFName').text)
    #         print(ele.find('Year2021') is None)
    #         # print(ele.find('SpectralRange').text)
    
    
    
    # for ele in root.iter():
    #     if ele.tag == sat:
    #         if has_sensor(sat, sensors):
    #             for ele_s in ele.iter():
    #                 print(ele_s.tag)
